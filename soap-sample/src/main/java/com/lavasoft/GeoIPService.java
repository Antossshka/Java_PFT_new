 ...
 * 2023-06-12T02:44:52.638+03:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "file:/D:/Java_PFT/soap-sample/src/main/resources/geoservice.WSDL",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Java_PFT/soap-sample/src/main/resources/geoservice.WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/Java_PFT/soap-sample/src/main/resources/geoservice.WSDL");
        }
        WSDL_LOCATION = url;
    }
